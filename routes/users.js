...
const { profile, register, login, logout, editProfile, creatBlog, deletePost, update, newBlog, updateImg, deleteUser, updateBlog, sendMail, comment } = require('../controllers/userControllers');
...
router.post("/contact", isLoggedIn, sendMail)
